...
class _NearbyLibrariesSection extends ConsumerWidget {
  const _NearbyLibrariesSection({required this.l10n});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final nearbyAsync = ref.watch(
      nearbyLibraryListProvider(const NearbyLibraryListParams()),
    );
    final scheme = Theme.of(context).colorScheme;
      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => context.push('/services?kind=library'),
              child: Text(l10n.viewAll),
            ),
          ],
        ),
        ...
        nearbyAsync.when(
          loading: () =>
              const SizedBox(height: 140, child: LoadingIndicator()),
            ...
            return SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return _NearbyLibraryCard(library: lib, l10n: l10n);
                },
              ),
            );
          },
...
class _NearbyLibraryCard extends StatelessWidget {
  const _NearbyLibraryCard({required this.library, required this.l10n});

  final FacilityModel library;
  final AppLocalizations l10n;

  @override
  Widget build(BuildContext context) {
    final scheme = Theme.of(context).colorScheme;
    final cover = library.coverImageUrl;

    return GlassContainer(
      level: GlassLevel.card,
      borderRadius: BorderRadius.circular(20),
      padding: EdgeInsets.zero,
      onTap: () => context.push('/services/library/${library.id}'),
      child: SizedBox(
        width: 250,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      library.isOpenNow ? l10n.openNow : l10n.closed,
                      style: Theme.of(context).textTheme.labelSmall?.copyWith(
                        color: library.isOpenNow
                            ? scheme.secondary
                            : scheme.error,
                        fontWeight: FontWeight.w700,
                      ),
                ...
                if (library.distanceFormatted != null)
                  Positioned(
                    top: 8,
                    right: 8,
                    child: Container(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    library.address ?? library.city?.name ?? '',
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: scheme.onSurfaceVariant,
