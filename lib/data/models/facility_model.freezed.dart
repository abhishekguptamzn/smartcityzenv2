...
@useResult
$Res call({
 String id, String name, String? description, String? address,@JsonKey(name: 'city_id') String? cityId, CityModel? city,@JsonKey(fromJson: _toDouble) double? latitude,@JsonKey(fromJson: _toDouble) double? longitude,@JsonKey(name: 'distance_km', fromJson: _toDouble) double? distanceKm,@JsonKey(name: 'distance_formatted') String? distanceFormatted,@JsonKey(name: 'image_url') String? imageUrl, Map<String, dynamic>? image, List<Map<String, dynamic>>? images, List<AmenityModel>? amenities, Map<String, dynamic>? location,@JsonKey(name: 'contact_phone') String? contactPhone,@JsonKey(name: 'contact_email') String? contactEmail,@JsonKey(name: 'opening_time') String? openingTime,@JsonKey(name: 'closing_time') String? closingTime, String status,@JsonKey(name: 'created_by') String? createdBy,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt,@JsonKey(includeFromJson: false, includeToJson: false) FacilityKind kind
});
...
as List<Map<String, dynamic>>?,amenities: freezed == amenities ? _self.amenities : amenities // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _FacilityModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.address,_that.cityId,_that.city,_that.latitude,_that.longitude,_that.distanceKm,_that.distanceFormatted,_that.imageUrl,_that.image,_that.images,_that.amenities,_that.location,_that.contactPhone,_that.contactEmail,_that.openingTime,_that.closingTime,_that.status,_that.createdBy,_that.createdAt,_that.updatedAt,_that.kind);case _:
  return orElse();
...
class _FacilityModel extends FacilityModel {
  const _FacilityModel({required this.id, required this.name, this.description, this.address, @JsonKey(name: 'city_id') this.cityId, this.city, @JsonKey(fromJson: _toDouble) this.latitude, @JsonKey(fromJson: _toDouble) this.longitude, @JsonKey(name: 'distance_km', fromJson: _toDouble) this.distanceKm, @JsonKey(name: 'distance_formatted') this.distanceFormatted, @JsonKey(name: 'image_url') this.imageUrl, final  Map<String, dynamic>? image, final  List<Map<String, dynamic>>? images, final  List<AmenityModel>? amenities, final  Map<String, dynamic>? location, @JsonKey(name: 'contact_phone') this.contactPhone, @JsonKey(name: 'contact_email') this.contactEmail, @JsonKey(name: 'opening_time') this.openingTime, @JsonKey(name: 'closing_time') this.closingTime, this.status = 'active', @JsonKey(name: 'created_by') this.createdBy, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt, @JsonKey(includeFromJson: false, includeToJson: false) this.kind = FacilityKind.library}): _image = image,_images = images,_amenities = amenities,_location = location,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FacilityModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.address, address) || other.address == address)&&(identical(other.cityId, cityId) || other.cityId == cityId)&&(identical(other.city, city) || other.city == city)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.distanceKm, distanceKm) || other.distanceKm == distanceKm)&&(identical(other.distanceFormatted, distanceFormatted) || other.distanceFormatted == distanceFormatted)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&const DeepCollectionEquality().equals(other._image, _image)&&const DeepCollectionEquality().equals(other._images, _images)&&const DeepCollectionEquality().equals(other._amenities, _amenities)&&const DeepCollectionEquality().equals(other._location, _location)&&(identical(other.contactPhone, contactPhone) || other.contactPhone == contactPhone)&&(identical(other.contactEmail, contactEmail) || other.contactEmail == contactEmail)&&(identical(other.openingTime, openingTime) || other.openingTime == openingTime)&&(identical(other.closingTime, closingTime) || other.closingTime == closingTime)&&(identical(other.status, status) || other.status == status)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.kind, kind) || other.kind == kind));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,address,cityId,city,latitude,longitude,distanceKm,distanceFormatted,imageUrl,const DeepCollectionEquality().hash(_image),const DeepCollectionEquality().hash(_images),const DeepCollectionEquality().hash(_amenities),const DeepCollectionEquality().hash(_location),contactPhone,contactEmail,openingTime,closingTime,status,createdBy,createdAt,updatedAt,kind]);
...
as List<Map<String, dynamic>>?,amenities: freezed == amenities ? _self._amenities : amenities // ignore: cast_nullable_to_non_nullable
