...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,address,cityId,city,latitude,longitude,distanceKm,distanceFormatted,imageUrl,const DeepCollectionEquality().hash(image),const DeepCollectionEquality().hash(images),logoUrl,const DeepCollectionEquality().hash(logo),const DeepCollectionEquality().hash(amenities),const DeepCollectionEquality().hash(location),contactPhone,contactEmail,openingTime,closingTime,status,checkoutEnabled,defaultCheckoutTime,defaultCheckoutDurationMinutes,batchManagementEnabled,bleVerificationEnabled,bleStrictMode,bleServiceUuid,bleSecretKey,bleProximitySensitivity,qrRotationInterval,createdBy,createdAt,updatedAt,kind]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,address,cityId,city,latitude,longitude,distanceKm,distanceFormatted,imageUrl,const DeepCollectionEquality().hash(_image),const DeepCollectionEquality().hash(_images),logoUrl,const DeepCollectionEquality().hash(_logo),const DeepCollectionEquality().hash(_amenities),const DeepCollectionEquality().hash(_location),contactPhone,contactEmail,openingTime,closingTime,status,checkoutEnabled,defaultCheckoutTime,defaultCheckoutDurationMinutes,batchManagementEnabled,bleVerificationEnabled,bleStrictMode,bleServiceUuid,bleSecretKey,bleProximitySensitivity,qrRotationInterval,createdBy,createdAt,updatedAt,kind]);
