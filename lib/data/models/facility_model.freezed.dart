...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,address,cityId,city,latitude,longitude,distanceKm,distanceFormatted,imageUrl,const DeepCollectionEquality().hash(image),const DeepCollectionEquality().hash(images),logoUrl,const DeepCollectionEquality().hash(logo),const DeepCollectionEquality().hash(amenities),const DeepCollectionEquality().hash(location),contactPhone,contactEmail,openingTime,closingTime,status,bleVerificationEnabled,bleServiceUuid,bleSecretKey,bleProximitySensitivity,qrRotationInterval,createdBy,createdAt,updatedAt,kind]);

@override
String toString() {
  return 'FacilityModel(id: $id, name: $name, description: $description, address: $address, cityId: $cityId, city: $city, latitude: $latitude, longitude: $longitude, distanceKm: $distanceKm, distanceFormatted: $distanceFormatted, imageUrl: $imageUrl, image: $image, images: $images, logoUrl: $logoUrl, logo: $logo, amenities: $amenities, location: $location, contactPhone: $contactPhone, contactEmail: $contactEmail, openingTime: $openingTime, closingTime: $closingTime, status: $status, bleVerificationEnabled: $bleVerificationEnabled, bleServiceUuid: $bleServiceUuid, bleSecretKey: $bleSecretKey, bleProximitySensitivity: $bleProximitySensitivity, qrRotationInterval: $qrRotationInterval, createdBy: $createdBy, createdAt: $createdAt, updatedAt: $updatedAt, kind: $kind)';
}
...
as String,bleVerificationEnabled: null == bleVerificationEnabled ? _self.bleVerificationEnabled : bleVerificationEnabled // ignore: cast_nullable_to_non_nullable
