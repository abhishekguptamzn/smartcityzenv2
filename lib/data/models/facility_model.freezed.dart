...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,address,cityId,city,latitude,longitude,distanceKm,distanceFormatted,imageUrl,const DeepCollectionEquality().hash(image),const DeepCollectionEquality().hash(images),logoUrl,const DeepCollectionEquality().hash(logo),const DeepCollectionEquality().hash(amenities),const DeepCollectionEquality().hash(location),contactPhone,contactEmail,openingTime,closingTime,status,bleVerificationEnabled,bleStrictMode,bleServiceUuid,bleSecretKey,bleProximitySensitivity,qrRotationInterval,createdBy,createdAt,updatedAt,kind]);
