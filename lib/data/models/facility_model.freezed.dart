...
as bool,attendanceManagementEnabled: null == attendanceManagementEnabled ? _self.attendanceManagementEnabled : attendanceManagementEnabled // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: 'attendance_management_enabled') final  bool attendanceManagementEnabled;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,address,cityId,city,latitude,longitude,distanceKm,distanceFormatted,imageUrl,const DeepCollectionEquality().hash(_image),const DeepCollectionEquality().hash(_images),logoUrl,const DeepCollectionEquality().hash(_logo),const DeepCollectionEquality().hash(_amenities),const DeepCollectionEquality().hash(_location),contactPhone,contactEmail,openingTime,closingTime,status,checkoutEnabled,defaultCheckoutTime,defaultCheckoutDurationMinutes,batchManagementEnabled,attendanceManagementEnabled,bleVerificationEnabled,bleStrictMode,bleServiceUuid,bleSecretKey,bleProximitySensitivity,qrRotationInterval,const DeepCollectionEquality().hash(_metadata),createdBy,createdAt,updatedAt,kind]);
